...
void add_questions()
{
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\Questions.bin","rb");
    if(fp==NULL)
    {
        fp=fopen("C:\\Movie Ticket Booking App\\Questions.bin","wb");
        if(fp==NULL)
        {
...
{
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\Users.bin","rb");
    if(fp==NULL)
    {
        fp=fopen("C:\\Movie Ticket Booking App\\Users.bin","wb");
        if(fp==NULL)
        {
            print_char(' ',79,25,BLACK);
...
{
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\users.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Users.bin\n",1,25,RED);
...
{
    print_basic_screen();
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\Theaters.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
...
{
    print_basic_screen();
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\Theaters.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Theaters.bin\n",1,25,RED);
...
{
    print_basic_screen();
    FILE *fp1=fopen("C:\\Movie Ticket Booking App\\Bookings.bin","rb");
    if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    FILE *fp2=fopen("C:\\Movie Ticket Booking App\\TempBookings.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    fclose(fp2);
    int x,y;
    x=remove("C:\\Movie Ticket Booking App\\Bookings.bin");
    if(x==0)
    {
        y=rename("C:\\Movie Ticket Booking App\\TempBookings.bin","C:\\Movie Ticket Booking App\\Bookings.bin");
        if(y==0)
            return 1;
    }
    return 0;
...
{
    FILE *fp1=fopen("C:\\Movie Ticket Booking App\\Movies.bin","rb");
    if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    FILE *fp2=fopen("C:\\Movie Ticket Booking App\\TempMovies.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
    ...
    while(fread(&mov,sizeof(mov),1,fp1)==1)
    {
        ...
        else
        {
            ...
            if(resp==0)
            {
                fclose(fp1);
                fclose(fp2);
                remove("C:\\Movie Ticket Booking App\\TempMovies.bin");
                return 0;
            }
        }
    ...
    fclose(fp2);
    int x,y;
    x=remove("C:\\Movie Ticket Booking App\\Movies.bin");
    if(x==0)
    {
        y=rename("C:\\Movie Ticket Booking App\\TempMovies.bin","C:\\Movie Ticket Booking App\\Movies.bin");
        if(y==0)
            return 1;
    }
    return 0;
...
int delete_theater()
{
   ...
   FILE *fp1=fopen("C:\\Movie Ticket Booking App\\Theaters.bin","rb");
   if(fp1==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Theaters.bin\n",1,25,RED);
   ...
   FILE *fp2=fopen("C:\\Movie Ticket Booking App\\TempTheaters.bin","wb");
    if(fp2==NULL)
    {
        print_char(' ',79,25,BLACK);
         ...
         else
         {
             if(th.is_booked==1)
             {
                 ...
                 if(resp==0)
                 {
                    fclose(fp1);
                    fclose(fp2);
                    remove("C:\\Movie Ticket Booking App\\TempTheaters.bin");
                    return 0;
                 }
             }
         }
    ...
    fclose(fp2);
    int x,y;
    x=remove("C:\\Movie Ticket Booking App\\Theaters.bin");
    if(x==0)
    {
        y=rename("C:\\Movie Ticket Booking App\\TempTheaters.bin","C:\\Movie Ticket Booking App\\Theaters.bin");
        if(y==0)
            return 1;
...
void add_movie()
{
    ...
    print_basic_screen();
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\Movies.bin","ab+");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movies.bin\n",1,25,RED);
...
{
    print_basic_screen();
    FILE *fp=fopen("C:\\Movie Ticket Booking App\\Movies.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Movies.bin\n",1,25,RED);
    ...
    {
        print_char(' ',79,25,BLACK);
        print_title("No Movies is Present.\n",1,25,RED);
        getch();
        return;
    }
    int row=8;
    ...
    {
        if(strcmp(mov.movie_id,prev_movie_id)!=0)
        {
            ...
            strcpy(prev_movie_id,mov.movie_id);
            row++;
        }
    }
    fclose(fp);
...
void change_password(user *u)
{
    ...
    else if(choice=='Y'||choice=='y')
    {
       ...
       // Read rec one by one
       // Match userid
       // If the userid matches then:
              // a. overwrite the new password in user *u
              // b. write the new password in file also
              // c. Show the success message
       rewind(fp);
       while(fread(&us,sizeof(us),1,fp)==1)
        {
            if(strcmp(us.userid,u->userid)==0)
...
int * get_seat_numbers(movie * m)
{
    ...
    FILE * fp = fopen("c:\\Movie Ticket Booking App\\SeatNumbers.bin", "wb+");
    if(fp == NULL)
    {
        print_char(' ', 79, 25, BLACK);
    ...
    do
    {
        ...
        do
        {
            ...
            if(seat_number==0)
            {
                ...
                fclose(fp);
                getch();
                if(remove("c:\\Movie Ticket Booking App\\SeatNumbers.bin"))
                {
                    print_char(' ', 79, 25, BLACK);
...
void booking(user * u)
{
    ...
    FILE * fp = fopen("c:\\Movie Ticket Booking App\\Bookings.bin", "ab+");
    if(fp == NULL)
    {
        print_char(' ', 79, 25, BLACK);
...
void show_booking_of_user(user *u)
{
    print_basic_screen();
    FILE *fp=fopen("c:\\Movie Ticket Booking App\\Bookings.bin","rb");
    if(fp==NULL)
    {
        print_char(' ',79,25,BLACK);
        print_title("Error in opening the file Booking.bin\n",1,25,RED);
        perror("Reason:");
        getch();
        return ;
    }
    ...
    {
        print_char(' ',79,25,BLACK);
        print_title("No Booking Present",1,25,RED);
        fclose(fp);
        getch();
        return ;
    }
...
*/
void cancel_booking_of_user(user *u)
{
    print_basic_screen();
    FILE *fp1=fopen("c:\\Movie Ticket Booking App\\Bookings.bin","rb");
    if(fp1==NULL)
...
int delete_my_Account(user *u)
{
    ...
    {
            FILE *fp1=fopen("c:\\Movie Ticket Booking App\\users.bin","rb");
            if(fp1==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            FILE *fp2=fopen("c:\\Movie Ticket Booking App\\TEMPusers.bin","wb");
            if(fp2==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            //bookinng
            FILE *fp3=fopen("c:\\Movie Ticket Booking App\\Bookings.bin","rb");
            if(fp3==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            FILE *fp4=fopen("c:\\Movie Ticket Booking App\\TempBookings.bin","wb");
            if(fp4==NULL)
            {
                print_char(' ',79,25,BLACK);
                print_title("Error in opening the file Bookings.bin\n",1,25,RED);
            ...
            if(x==0)
            {
                ...
                if(y==0)
                {
                    x=remove("c:\\Movie Ticket Booking App\\users.bin");
                    if(x==0)
                        {
                            y=rename("c:\\Movie Ticket Booking App\\Tempusers.bin","c:\\Movie Ticket Booking App\\users.bin");
                            if(y==0)
                            {
                                print_char(' ',79,25,0);
